...
#ifndef SYMPILER_PROJ_ERROR_H
#define SYMPILER_PROJ_ERROR_H
...
#define _halide_internal_assertion(condition, flags) \
  (condition)                                        \
      ? (void)0                                      \
      : ::Sympiler::Internal::Voidifier() &            \
        ::Sympiler::Internal::ErrorReport(__FILE__, __LINE__, #condition, flags).ref()
