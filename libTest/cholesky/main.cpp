...
int main(int argc, char *argv[]) {
    ...
    double CHOLMODNumTime = 0, SympilerNumTime=0;
    ...
    BCSC *L = buildingInspectionSets(1, Amat, NULL, NULL, nrelax, zrelax,
    ...
    cholesky_left_sn_07(n,A2->p,A2->i,A2->x,colL,L->s,li_ptr,valL,
                        L->super,L->nsuper,prunePtr,pruneSet,map, contribs);

    end = std::chrono::system_clock::now();
    elapsed_seconds = end-start;
    SympilerNumTime=elapsed_seconds.count();


    //double ts [3], bnorm, anorm;
    FILE *f ;
    cholmod_sparse *Ac1 ;
...
//        cout<<"\n";
   ...
   if(cnt>0)
    ...
    cout<<f1<<","<<SympilerNumTime<<","<<CHOLMODNumTime <<","<< NNZL <<",";
