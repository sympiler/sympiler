...
namespace sym_lib {
 namespace parsy {
  ...
  int dfsC(int p, int k, int *Post, int *Head, int *Next, int *Pstack) {
   int j, phead;
  ...
  int dfs_CSC_CC(size_t n, int j, int *Gp, int *Gi, int *marked, int top, int *xi, int *pstack,
  ...
  int
  dfs_BCSC_CC(size_t n, int j, size_t *Gp, size_t *Gi_ptr, int *Gi, const int *blk2Col, const int *col2Blk, int *marked,
              int top, int *xi, int *pstack, std::vector<int> &clashedNodes, const int *pinv) {
  ...
  int
  dfs_BCSC(size_t n, int j, size_t *Gp, size_t *Gi_ptr, int *Gi, const int *blk2Col, const int *col2Blk, bool *marked,
           int top, int *xi, int *pstack, const int *pinv) {
   int i, p, done, jnew, head = 0;
   //bool *marked = new bool[n]();
   //if (!CS_CSC (G) || !xi || !pstack) return (-1) ;    /* check inputs */
   //Gp = G->p ; Gi = G->i ;
