...
namespace sym_lib {
 namespace parsy {
  ...
  int postOrderSpliting(int inSize, int *inTree, double *inCost, int *inChildPtr, int *inChildNo, int *nChild, int n,
                        int partitionNum, int &outSize, double *outCost, int *outNode2Par,
